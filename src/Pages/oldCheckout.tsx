...
export default function OldCheckout() {
    ...
    const [fulano, setFulano] = useState('')
            ...
            <div className="grid">
                ...
                <div className="col-12 md:col-4" style={{ background: 'white' }}>
                    <div className="formStyle">
                        <div className='grid' style={{ margin: '1%' }}>
                            ...
                            <div className='col-6'>
                                <span className="p-float-label" >
                                    ...
                                    <InputText value={fulano} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFulano(e.target.value)} />
                                    <label htmlFor="email">Nome Do Personagem</label>
                                </span>
                            </div>


                            <div className='col-6' style={{ marginBottom: '2%' }}>
                                <span className="p-float-label" >
                                    <InputNumber value={coins} onValueChange={(e) => setCoins(e.value!)} useGrouping={false} maxLength={5} />
                                    <label htmlFor="coins">Quantidade de Coins</label>
                                </span>
                            </div>
                        </div>
                        <form>
                            <div className='grid' style={{ margin: '2%' }}>
                                <div className='title' style={{ width: '100%' }}>
                                    <div className='grid'>
                                        <div style={{ display: 'flex', alignItems: 'center' }}> <i className="pi pi-user" style={{ color: '#0088FF' }} /></div>
                                ...
                                <div className='grid' style={{ width: '100%' }}>
                                    ...
                                    <div className='col-5 md:col-6' style={{ margin: 0, marginTop: '2%' }}>
                                        <span className="p-float-label" >
                                            <InputMask value={phone} unmask onChange={(e) => { setPhone(e.target.value!) }} mask="(99) 99999-9999" />
                                            <label htmlFor="phone">Celular</label>
                                        </span>
                                    </div>
                                    <div className='col-7 md:col-6' style={{ margin: 0, marginTop: '2%' }}>
                                        <span className="p-float-label" >
                            ...
                            <div className='grid' style={{ margin: '2%' }}>
                                ...
                                <div className='grid' style={{ width: '100%' }}>
                                    ...
                                    <div className='col-10 md:col-5' style={{ margin: 0, marginTop: '2%' }}>

                                        <span className="p-float-label" >
                                            <InputMask value={postalCode} unmask onChange={(e) => { setPostalCode(e.target.value!) }} mask="99999-999" style={{ width: '100%' }} />
                                    ...
                                    <div className='col-12 md:col-11' style={{ margin: 0, marginTop: '2%' }}>
                                        <span className="p-float-label" >
                                    ...
                                    <div className='col-6 md:col-6' style={{ margin: 0, marginTop: '2%' }}>
                                        <span className="p-float-label" >
                                    ...
                                    <div className='col-6 md:col-6' style={{ margin: 0, marginTop: '2%', height: '100%' }}>
                                        <span className="p-float-label" >
                                            <Dropdown value={state} id="state" onChange={(e) => { setState(e.target.value) }} options={brazilStates} style={{ minHeight: '100%', width: '80%' }}
                                            />
                            ...
                            <div className='grid' style={{ margin: '2%' }}>
                                ...
                                <div className='grid' style={{ width: '100%' }}>
                                    ...
                                    <div className='col-12 md:col-6' style={{ margin: 0, marginTop: '2%', height: '100%' }}>
                                        <span className="p-float-label" >
                                            <Dropdown value={installments} id="installment" onChange={(e) => { setInstallments(e.target.value) }} style={{ minHeight: '100%', width: '80%' }}
                                            />
